...
periods = [
    ...
    ('eval', H1, '2026-07-20', '2026-07-24', '2026-07-27', '2026-08-10'),
    ('feedback', H1, '2026-08-11', '2026-08-18', '2026-08-25', '2026-08-31'),
...
for e in emps:
    ...
    st = 'not_started'
    if r < 22:
        self_at = at(dshift(EV_H1['start'], -rng(1, 10, 'evsd', eid)), rng(9, 20, 'evsh', eid))
        st = 'self_submitted'
    if r < 8:
