 ...
 *    - 성과관리 도메인은 후속 탐색 경로(근거 확인 → What-if → 조치)가 정형적인데
 ...
 *      · 등급/평가 → 계산 근거·What-if / 목표/KR → 정렬 점검·가중치 조정
